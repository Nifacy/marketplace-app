    ...
    <div className={styles.nav}>
      <Link to="/">
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M22 22L2 22" stroke="#9B9B9B" stroke-width="2" stroke-linecap="round" />
          <path
          ...
          <path
            ...
            stroke-linecap="round"
          />
          <path d="M4 22V9.5" stroke="#9B9B9B" stroke-width="2" stroke-linecap="round" />
          <path d="M20 9.5V13.5M20 22V17.5" stroke="#9B9B9B" stroke-width="2" stroke-linecap="round" />
          <path
